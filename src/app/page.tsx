      ...
      <div>
        ...
        <div className="mt-6 space-y-2 text-gray-700">
          <div>
            ...
            <a href="mailto:emailnyaartmedia@gmail.com" rel="noopener noreferrer" className="hover:underline">
              emailnyaartmedia@gmail.com
            </a>
          </div>
          <div>
            <span className="font-medium">Whatsapp:</span>{" "}
            <a href="https://wa.me/628563656307" target="_blank" rel="noopener noreferrer" className="hover:underline">
              +62 85 6365 6307
            </a>
          </div>
    ...
    <Section id="footer">
      <div className="grid md:grid-cols-3 gap-6 items-start">
        ...
        <div className="text-sm text-gray-600">
          ...
          <div className="grid md:grid-cols-12 mt-2 text-gray-600 text-sm">
            <a href="https://www.instagram.com/artmediadeveloper" rel="noopener noreferrer" target="_blank" className="hover:underline">
              <svg className="w-6 h-6 text-gray-800 dark:text-dark" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path fill="currentColor" fill-rule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clip-rule="evenodd" />
              </svg>
            </a>
            <a href="https://www.facebook.com/artmediadevelopers/" rel="noopener noreferrer" target="_blank" className="hover:underline">
            ...
            <a href="https://wa.me/628563656307" rel="noopener noreferrer" target="_blank" className="hover:underline">
              <svg className="w-6 h-6 text-gray-800 dark:text-dark" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
